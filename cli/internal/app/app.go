...
import (
	...
	"github.com/neria-cloud/meridian/cli/internal/config"
	"github.com/neria-cloud/meridian/cli/internal/harness"
	"github.com/neria-cloud/meridian/cli/internal/installer"
	"github.com/neria-cloud/meridian/cli/internal/mcp"
	"github.com/neria-cloud/meridian/cli/internal/runtime"
	"github.com/neria-cloud/meridian/cli/internal/secrets"
	"github.com/neria-cloud/meridian/cli/internal/ui/logo"
	"github.com/neria-cloud/meridian/cli/internal/ui/tui"
	"github.com/neria-cloud/meridian/cli/internal/update"
	"golang.org/x/term"
)
...
func (a *App) Run(ctx context.Context) error {
	...
	if updateVersion != "" {
		...
		if shouldUpdate {
			...
			if err != nil {
				fmt.Fprintf(a.out, "Updated successfully. Please restart meridian.\n")
				return nil
			}
